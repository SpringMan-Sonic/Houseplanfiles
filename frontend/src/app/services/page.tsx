...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Services | HousePlanFiles", description: "Custom house plans, 3D elevations, interior design and vastu services.", url: "https://www.houseplanfiles.com/services", images: [{ url: "/architect_hero.png", width: 1200, height: 630, alt: "Architecture Services India" }] },
  twitter: { card: "summary_large_image", title: "Services | HousePlanFiles", description: "Custom house plans, 3D elevations and interior design services.", images: ["/architect_hero.png"] },
