          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
            <div className="flex flex-col items-center mb-12">
              <div className="relative mb-6">
                <Avatar className="w-32 h-32 sm:w-40 h-40 border-4 border-white/20 shadow-2xl">
                  <AvatarImage src={getFileUrl(contractor.photoUrl)} alt={contractor.name} />
                  <AvatarFallback className="bg-orange-600 text-white text-4xl font-extrabold">
                    {contractor.name?.charAt(0)}
                  </AvatarFallback>
                </Avatar>
                {contractor.contractorType === "Premium" && (
                  <div className="absolute -bottom-2 -right-2 bg-orange-500 text-white p-2 rounded-full shadow-lg border-2 border-gray-900">
                    <Star className="w-5 h-5 fill-current" />
                  </div>
                )}
              </div>
              <Badge className="bg-orange-500 mb-4 px-4 py-1.5 text-xs font-extrabold uppercase tracking-wider">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
                <p className="text-gray-400 font-extrabold flex items-center gap-2 uppercase tracking-widest text-[10px]">
                ...
                {contractor.serviceTypes && contractor.serviceTypes.length > 0 && (
                  <div className="flex gap-2">
                    {contractor.serviceTypes.map((type: string) => (
                      <Badge key={type} className="bg-blue-600/30 text-blue-400 border border-blue-500/50 text-[10px] py-0.5 px-3">
                        {type}
                      </Badge>
                    ))}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="flex flex-col gap-4">
                <Button onClick={() => handleInquiryAction()} className="w-full bg-orange-600 hover:bg-orange-700 h-16 rounded-2xl text-lg font-extrabold shadow-2xl shadow-orange-600/40 text-white transition-all active:scale-95">
                ...
                <Button 
                  ...
                  className="w-full bg-[#25D366] hover:bg-[#128C7E] h-16 rounded-2xl text-lg font-extrabold shadow-2xl shadow-green-600/40 text-white transition-all active:scale-95"
                >
                ...
                {contractor.portfolioUrl && (
                  <a href={getFileUrl(contractor.portfolioUrl)} target="_blank" rel="noreferrer" className="block w-full">
                    <Button variant="outline" className="w-full h-16 rounded-2xl border-2 border-white/20 text-gray-900 bg-white/90 hover:bg-white backdrop-blur-md font-extrabold text-lg transition-all">
